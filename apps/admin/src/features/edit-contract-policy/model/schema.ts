...
export const buildUpdateContractPolicySchema = (
  ...
  z
    ...
    .transform((data) => ({
      ...
      conditions: data.conditions.map((rule) => ({
        ...rule,
        id: rule.id || undefined,
      })),
    }));

export const updateContractPolicySchema = buildUpdateContractPolicySchema();

export type UpdateContractPolicySubmitData = z.output<
  typeof updateContractPolicySchema
>;
